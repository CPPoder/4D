...
public:
    ...
    virtual void render(fd::Matrix44f *view, fd::Vector4f *position) = 0;
    ...
    unsigned int projectionColor1(fd::Vector4f pointIn, float colorDeepness);

    unsigned int projectionColor2(fd::Vector4f pointIn,float colorDeepness);
